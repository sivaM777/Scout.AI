...
export const mockAnalysisReport: AnalysisReport = {
  ...
  pricing: {
    ...
    marketplacePrices: [
      {
        marketplaceSlug: "ajio",
        marketplaceLabel: "Ajio",
        productName: "Relaxed Fit Linen Blend Dress",
        productUrl: "https://www.ajio.com/sample-product/p/123456",
        currency: "INR",
        currentPrice: 1899,
        ...
        matchScore: 1,
        priceStatus: "current",
        isOriginalListing: true,
      },
      {
        marketplaceSlug: "myntra",
        marketplaceLabel: "Myntra",
        productName: "Similar Linen Blend Dress",
        productUrl: "https://www.myntra.com/dresses/sample-product/30123456/buy",
        currency: "INR",
        currentPrice: 1799,
        availability: "available",
        differenceAmount: -100,
        differencePercent: -5.27,
        matchScore: 0.82,
        priceStatus: "cheaper",
        isOriginalListing: false,
        note: "Matched via live marketplace lookup.",
      },
      {
        marketplaceSlug: "amazon",
        marketplaceLabel: "Amazon",
        productName: "Comparable Linen Blend Dress",
        currency: "INR",
        currentPrice: null,
        ...
        isOriginalListing: false,
        note: "No close live match found.",
      },
    ],
  },
  alternatives: [
